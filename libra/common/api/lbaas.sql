...
CREATE TABLE billing (
    id int(11) NOT NULL,
    exists_updated  TIMESTAMP                NOT NULL DEFAULT '0000-00-00 00:00:00',              # timestamp of when billing was last updated with exists messages
    usage_updated   TIMESTAMP                NOT NULL DEFAULT '0000-00-00 00:00:00',              # timestamp of when billing was last updated with usage messages
    stats_updated   TIMESTAMP                NOT NULL DEFAULT '0000-00-00 00:00:00',               # timestamp of when stats data was last gathered
    PRIMARY KEY (id)
